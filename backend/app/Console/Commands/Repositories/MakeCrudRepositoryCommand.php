...
class MakeCrudRepositoryCommand extends GeneratorCommand
{
    /**
     * The name of your command.
     * This is how your Artisan's command shall be invoked.
     */
    protected $name = 'app:make-crud-repository';
    ...
    {
        return base_path('stubs/repositories/repository-crud.stub');
    }
